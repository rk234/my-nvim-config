...
vim.keymap.set('n', '<BS>', '<C-^>', { desc = 'Go to previous buffer' })
...
local function close_empty_unnamed_buffers()
  ...
  for _, bufnr in ipairs(buffers) do
    ...
    if vim.api.nvim_buf_is_loaded(bufnr) and vim.api.nvim_buf_get_name(bufnr) == '' and vim.api.nvim_buf_get_option(bufnr, 'buftype') == '' then -- Get all lines in the buffer
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ft', ':Telescope themes<CR>', { desc = '[S]earch [T]hemes' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ld', vim.diagnostic.open_float, 'Show [D]iagnostics', { 'n', 'x' })
  ...
  require 'custom.plugins.telescope_themes',
